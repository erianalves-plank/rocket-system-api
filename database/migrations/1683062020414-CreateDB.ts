...
export class CreateDB1683062020414 implements MigrationInterface {
    name = 'CreateDB1683062020414'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rocket" ("name" character varying NOT NULL, "id" character varying(255) NOT NULL, CONSTRAINT "PK_89b0efae402998623e1367aa34a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "launch" ("id" SERIAL NOT NULL, "launchCode" character varying NOT NULL, "date" character varying NOT NULL, "success" boolean NOT NULL, "rocketId" character varying(255), "crewId" integer, CONSTRAINT "REL_b01b01e9029a8e3c1a92851199" UNIQUE ("rocketId"), CONSTRAINT "REL_0f1c4f512003ae87bb8df983d4" UNIQUE ("crewId"), CONSTRAINT "PK_0efd83695074312cab129ff59f0" PRIMARY KEY ("id"))`);
